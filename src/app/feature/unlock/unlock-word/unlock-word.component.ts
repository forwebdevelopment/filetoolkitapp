...
@Component({
  selector: 'app-unlock-word',
  imports: [FormsModule ,CommonModule],
  templateUrl: './unlock-word.component.html',
  styleUrl: './unlock-word.component.css'
})
export class UnlockWordComponent {
...
constructor(public helper:Helper){
  ...
  onUnlockword(): void {
    ...
    setTimeout(() => {
      ...
      if(this.selectedFile){
        this.helper.lockUnlockFileHelper(this.selectedFile,this.password, 'WORD', 'unlock', this.fileName)
      }
    }, 2000);
  }
}
